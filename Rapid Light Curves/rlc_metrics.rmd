...
for (sample in sampleNames) {
    ...
    for (well in 1:6) {
        ...
        curve <- data.frame(PAR = pars, QY = Webb_QY_PI(QY_max, Ek, pars), Well = well)
    ...
    # print(plot)
    suppressMessages(ggsave(paste0("Rapid Light Curves/QY/plots/", sample, "Webb.png"), plot))
}

cat("\n")

write.csv(output, "Rapid Light Curves/rlc_qy_metrics_webb.csv")
```
